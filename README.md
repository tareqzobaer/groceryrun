...
Designed with Bangladeshi users in mind, Grocery Run supports English and Banglish input, common local grocery items, and the informal formats people typically use when creating shopping lists.
